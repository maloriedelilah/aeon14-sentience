...
export interface Book { title: string; subtitle?: string; slug: string; description: string; cover?: string; datePublished?: string; storyDate?: string; language: string; genres: string[]; editions: Edition[]; comps: Comp[]; authorSlugs: string[]; seriesSlug?: string; seriesPosition?: number; }
